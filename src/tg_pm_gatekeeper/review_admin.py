...
:root{{--bg-primary:#0F172A;--bg-secondary:#1B2336;--bg-tertiary:#272F42;--text-primary:#F8FAFC;--text-secondary:#94A3B8;--text-muted:#64748B;--border:#475569;--accent-primary:#22C55E;--accent-danger:#EF4444;--accent-warning:#F59E0B;--accent-info:#3B82F6;--surface-elevated:#1E293B;--shadow-sm:0 1px 3px rgba(0,0,0,0.3);--shadow-md:0 4px 6px rgba(0,0,0,0.4);--shadow-lg:0 10px 15px rgba(0,0,0,0.5);--font-ui:"Fira Sans",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;--font-mono:"Fira Code",SFMono-Regular,Consolas,"Liberation Mono",Menlo,monospace}}
