...
:root{{--bg-primary:#0F172A;--bg-secondary:#1B2336;--bg-tertiary:#272F42;--text-primary:#F8FAFC;--text-secondary:#CBD5E1;--text-muted:#94A3B8;--border:#64748B;--accent-primary:#22C55E;--accent-danger:#F87171;--accent-warning:#F59E0B;--accent-info:#60A5FA;--surface-elevated:#1E293B;--shadow-sm:0 1px 3px rgba(0,0,0,0.3);--shadow-md:0 4px 6px rgba(0,0,0,0.4);--shadow-lg:0 10px 15px rgba(0,0,0,0.5);--font-ui:"Fira Sans",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;--font-mono:"Fira Code",SFMono-Regular,Consolas,"Liberation Mono",Menlo,monospace}}
...
.live{{display:flex;align-items:center;gap:.5rem;color:var(--accent-primary);font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em}}.live i{{width:.5rem;height:.5rem;border-radius:50%;background:var(--accent-primary);box-shadow:0 0 0 3px rgba(34,197,94,.2);animation:pulse 2s infinite}}
