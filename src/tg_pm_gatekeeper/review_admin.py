...
.queue-intro{{max-width:960px;margin-bottom:2.5rem}}h1,h2{{font-family:Georgia,serif;line-height:1.1}}.queue-intro h2{{max-width:18ch;font-size:clamp(2rem,4vw,3.25rem);font-weight:400;letter-spacing:-.035em;margin:.55rem 0 1.3rem}}
.queue-intro p{{max-width:72ch;color:var(--muted)}}.refresh-note{{margin-top:1.2rem;padding-left:1rem;border-left:3px solid var(--safe);font-size:.78rem}}.eyebrow{{margin:0;text-transform:uppercase;letter-spacing:.13em;font-size:.7rem;font-weight:800;color:var(--signal)}}
